...
static constexpr auto generate_bottom_top()
{
...
static constexpr auto pair = generate_bottom_top();
static constexpr auto BOTTOM = pair.first;
static constexpr auto TOP = pair.second;
...
static inline bool haswon(uint64_t board)
{
